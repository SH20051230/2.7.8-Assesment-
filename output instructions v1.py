# This is a program that outputs the instructions to new users
# helping them to quickly adapt of how to use it
# The function that will print out instructions
